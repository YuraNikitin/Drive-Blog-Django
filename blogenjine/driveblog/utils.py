...
class ObjectListMixin():
    """This is class mixin, designed to view a list of Post's or Tag's"""
    model = None
    obj_query = None
...
class ObjectDetailMixin:
    """This is class mixin, designed to detail view a list of Post's or Tag's"""
    model = None
    template = None
...
class ObjectCreateMixin():
    """This is class mixin, designed to create Post or Tag"""
    form_model = None
    template = None
    model = None
...
class ObjectUpdateMixin():
    """This is class mixin, designed to update Post or Tag"""
    model = None
    model_form = None
    template = None
...
class ObjectDeleteMixin():
    """This is class mixin, designed to delete Post or Tag"""
    model = None
    template = None
    redirect_url = None
